    ...
    if (connected) {
      ...
      if (neolineN3) {
        ...
        neolineN3.signMessage({
          message: 'Bet to the moon?'
        }).then(function (signedMessage) {
          var publicKey = signedMessage.publicKey,
